...
public class Translations {
	...
	public static final Translation MESSENGER_PREFIX = new Translation("messenger.settings.prefix").add(ComponentType.CHAT, text("<!italic><light_purple><bold>Fluffy <reset>"));
	...
	public static final Translation COMMAND_TAG_NO_TAGS_OTHER = new Translation("commands.tag.no-tags-other").add(ComponentType.CHAT, text("<red>%player% does not have any combat tags!"));
	...
	public static final Translation COMMAND_TAG_INFO_OTHER = new Translation("commands.tag.info-other").add(ComponentType.CHAT, text("<yellow>%player%'s combat tags (Highest = Newest)"));
	public static final Translation COMMAND_TAG_INFO_BLOCK = new Translation("commands.tag.info-block").add(ComponentType.CHAT, text("<yellow>- <white>(Block) <yellow>%who% <white>x%x%<gray>, <white>y%y%<gray>, <white>z%z%<gray>, <white>%world% <gray>(<yellow>%ticks% <gray>ticks)"));
	public static final Translation COMMAND_TAG_INFO_PLAYER = new Translation("commands.tag.info-player").add(ComponentType.CHAT, text("<yellow>- <yellow>%who% <gray>(<yellow>%ticks% <gray>ticks)"));
	...
	public static final Translation COMBAT_ENTER_VICTIM = new Translation("combat.enter.victim").add(ComponentType.CHAT, text("<red>You're now in combat with <white>%player%<red>!"));
	public static final Translation COMBAT_ENTER_ATTACKER = new Translation("combat.enter.victim").add(ComponentType.CHAT, text("<red>You're now in combat with <white>%player%<red>!"));
	...
	public static JsonObject getDefaults(){
		return TranslationGsonHelper.getDefaults(Translations.class, MiniMessage.miniMessage(), new Gson());
	}
